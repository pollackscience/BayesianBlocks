...
def make_comp_plots(data, p0, save_dir,title=None, xlabel=None, ylabel=None):
    #normed_counts_data, bb_edges = np.histogram(data,bayesian_blocks(data,p0=p0), density=True)
    ...
    plt.savefig(save_dir+'/plots/z_data_hist_comp2.pdf')
